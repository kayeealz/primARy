...
public class Ul_CameraFocus : MonoBehaviour
{
    [HideInInspector] public GameObject Target;
    public float DistanceFromTarget = 7f;
    [HideInInspector] public float FollowSpeed = 50f;
    public float Sensitivity = 5f;
    public float RotationDamping = 2.5f;
    public float HeightDamping = 2.5f;
    [HideInInspector] public bool findbyname;
    [HideInInspector] public string Gameobjname;
    [HideInInspector] public float ClampValue = 2f;
