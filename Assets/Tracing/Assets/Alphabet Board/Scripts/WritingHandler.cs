...
public class WritingHandler : MonoBehaviour
{
		...
		private void PlayPositiveSound ()
		{
				if (positiveSound != null){}
						AudioSource.PlayClipAtPoint (positiveSound, Vector3.zero, 5f);//play the cheering sound effect
		}
		...
		{
				if (wrongSound != null){}
						AudioSource.PlayClipAtPoint (wrongSound, Vector3.zero, 5f);//play the cheering sound effect
		}
